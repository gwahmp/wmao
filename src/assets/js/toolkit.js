...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (productLink && purchaseCode && (purchaseCode==pcode)) {
        ...
        downloadTitle.innerHTML = "<h3>" + productTitle + "</h3> <span>Product Direct Link:<br/></span><code>" + productLink + "</code><br/><span style='color:green;'>If below download button blocks pop-up, visit above link directly to download the product.</span><br/><span>If still any issue with the products, chat with me through <a href='https://wa.me/919976126754?text=Hi, Regarding digital assets products download.' target='_blank'>WhatsApp here</a>.</span>";
